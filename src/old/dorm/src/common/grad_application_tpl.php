<?
	...
	$application = new GraduateApplication($mysqlhost, $mysqluser, $mysqlpass, $mysqldb, $graduateStudentTable, $graduateApplicantTable, $graduatePeriodTable, $graduateRateTable, $graduatePriceTable, $roomTable, $accountTable, $graduatePreferenceTable, $graduatePaymentTable, $graduateRefundTable);
