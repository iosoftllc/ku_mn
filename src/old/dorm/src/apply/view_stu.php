...
//echo "aaa" . $student->studentDOB;
		...
		$place_term = "";
		if ($student->linkPeriodCode) $place_term = $student->linkPeriodName . ": " . getEnglishDate($student->linkPeriodSDate) . " - " . getEnglishDate($student->linkPeriodEDate);
		$place_ip = "";
		...
		$place_addr = "";
		if ($student->linkRoomCode) {
			$place_addr = $student->linkRoomCode;
			if (strtoupper(substr($student->linkRoomCode, 0, 1)) == "A") $place_addr .= "<br>Anam 2 Hall";
			else $place_addr .= "<br>CJ International House";
			$place_addr .= "<br>Korea University<br>Anam-Dong Seongbuk-Gu<br>Seoul, 136-701 Korea";
		}
