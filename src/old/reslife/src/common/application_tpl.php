<?
	...
	if ($html_file == "app_calendar") {
		...
		$on_load = "";
		$page_name = "룸배정현황";
	} else if ($html_file == "app_calendar_old") {
		$main_index = 1;
		$sub_index = 8;
		$on_load = "";
		$page_name = "[OLD]룸배정현황";
	...
	$application = new cApplication($mysqlhost, $mysqluser, $mysqlpass, $mysqldb, $studentTable, $applicantTable, $rateTable, $periodTable, $roomTable, $priceTable, $preferenceTable, $paymentTable, $accountTable, $refundTable, $historyAccessTable, $historyWorkTable);
