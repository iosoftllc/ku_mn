<?
	...
	$refund = new cRefund($mysqlhost, $mysqluser, $mysqlpass, $mysqldb, $refundTable, $periodTable, $applicantTable, $paymentTable, $studentTable, $historyAccessTable, $historyWorkTable);
