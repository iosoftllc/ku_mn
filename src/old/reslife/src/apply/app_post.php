	...
	if ($log_flag) {
		if ((int)$ihouse_admin_info[grade] < 8) include_once("../common/check_auth_tpl.php");
			...
			if ($mode == "edit") {
				...
				$dorm_waived = $application->applyDormWaived;
				...
				$rate6 = $application->preRateCode[5];
				$rate7 = $application->preRateCode[6];
				$rate8 = $application->preRateCode[7];
				...
				else if (trim($application->preRateCode[3]) && $application->preRateCode[3] == $application->linkRateCode) $sel_rate = "4";
				else if (trim($application->preRateCode[4]) && $application->preRateCode[4] == $application->linkRateCode) $sel_rate = "5";
				else if (trim($application->preRateCode[5]) && $application->preRateCode[5] == $application->linkRateCode) $sel_rate = "6";
				else if (trim($application->preRateCode[6]) && $application->preRateCode[6] == $application->linkRateCode) $sel_rate = "7";
				else if (trim($application->preRateCode[7]) && $application->preRateCode[7] == $application->linkRateCode) $sel_rate = "8";
