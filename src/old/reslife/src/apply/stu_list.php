<?
	...
	if ($log_flag) {
		if ((int)$ihouse_admin_info[grade] != 7 && (int)$ihouse_admin_info[grade] < 8) include_once("../common/check_auth_tpl.php");
			...
			$list_no = 20;
			$all_count = $student->getStudentCount($sdate, $edate, $s_type, $s_text, $s_kind, $s_current);
			...
			$student->getStudentList($sdate, $edate, $offset, $list_no, $s_type, $s_text, $s_kind, $s_current, $sort);
