function sortList(val) {
	...
	document.RoomForm.action = "../../src/graduate/room_list.php";
...
function postRoom(code) {
	if (code != "") {
		...
		document.RoomForm.action = "../../src/graduate/room_post.php";
		document.RoomForm.submit();
	}
}
...
function downloadExcel() {
	document.RoomForm.action = "../../src/graduate/room_excel.php";
	document.RoomForm.submit();
}