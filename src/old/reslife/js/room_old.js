function sortList(val) {
	...
	document.RoomForm.action = "../../src/apply/room_old_list.php";
...
function postRoom(code) {
	if (code != "") {
		...
		document.RoomForm.action = "../../src/apply/room_old_post.php";
		document.RoomForm.submit();
	}
}
...
function downloadExcel() {
	document.RoomForm.action = "http://reslife.korea.ac.kr/admin/src/apply/room_old_excel.php";
	document.RoomForm.submit();
}