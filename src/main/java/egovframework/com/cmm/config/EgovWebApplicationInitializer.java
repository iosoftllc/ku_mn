...
public class EgovWebApplicationInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		// Lucy-XSS 필터
		// egov 에서 제공한 필터를 사용하지않고 Lucy-XSS 필터를 사용한다.
		FilterRegistration.Dynamic htmlTagFilter = servletContext.addFilter("htmlTagFilter", new XssEscapeServletFilter());
		htmlTagFilter.addMappingForUrlPatterns(null, false, "/*");
		...
		//-------------------------------------------------------------
		// IOSF ContextListener 설정
		//-------------------------------------------------------------
		servletContext.addListener(new iosf.com.sys.IosfContextListener());
